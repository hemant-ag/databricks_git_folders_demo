...
The 'databricks_git_folders_proj' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_git_folders_proj_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/databricks_git_folders_proj.job.yml). The schedule
